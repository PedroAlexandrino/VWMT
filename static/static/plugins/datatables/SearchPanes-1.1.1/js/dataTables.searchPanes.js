    ...
    var SearchPanes = /** @class */ (function () {
        ...
        SearchPanes.prototype._updateFilterCount = function () {
            ...
            if (filterCount) {
                ...
                var message = this.s.dt.i18n('searchPanes.title', 'Filtro Ativos: %d', filterCount);
                ...
                // Run the message through the internationalisation method to improve readability
                var message = this.s.dt.i18n('searchPanes.title', '');
                $$1(this.dom.title).text(message);
                if (this.c.filterChanged !== undefined && typeof this.c.filterChanged === 'function') {
                    this.c.filterChanged(filterCount);
                }
        ...
        SearchPanes.classes = {
            clear: 'dtsp-clear',
            clearAll: 'btn btn-primary float-right',
            container: 'dtsp-searchPanes',
            emptyMessage: 'dtsp-emptyMessage',
            hide: 'dtsp-hidden',
            panes: 'dtsp-panesContainer',
            search: 'dtsp-search',
            title: 'font-weight-bold text-primary float-left',
